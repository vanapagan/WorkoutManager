...
public class PercentageCycleValue extends CycleValue {
    ...
    public PercentageCycleValue(String name, double value, double multiplier, double floor, double ceiling, double initialValue) {
        super(name, value, multiplier, floor, ceiling, initialValue);
    }
